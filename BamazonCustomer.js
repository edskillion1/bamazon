    ...
    },
    {
      ...
      if(res[whatToBuy].StockQuantity >= howMuchToBuy){
        ...
        {ItemID: ans.id}
            ...
            if(err) throw err;
            console.log("Success! Your total price is $" + grandTotal.toFixed(2) + ". Your item(s) will be shipped to you in 3-5 business days.");
        });
        ...
        console.log("Sorry, there's not enough of those in stock!");
      }
...
function reprompt(){
  inquirer.prompt([{
    ...
    if(ans.reply){
      ...
      console.log("Thanks for your business.  We will see you soon!");
    }
  });
}
